...
class LocalNotificationshelper {
  ...
  static Future showScheduledNotification({required int id, required String title, required String body, required String payload}) async {
  ...
  // hour ---> midnight: 0 ----> 23
  static Future<bool> showScheduledDailyNotification({required int id, required String title, required String body, required String payload, int hour = 10, int minute = 0}) async {
    const AndroidNotificationDetails androidNotificationDetails = AndroidNotificationDetails(
      'Daily notification',
      'Daily Notification',
      channelDescription: 'Daily notification for your Attempt',
      importance: Importance.max,
      priority: Priority.high,
      ticker: 'ticker',
    );
